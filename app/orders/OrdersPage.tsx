    ...
    <div className="bg-white">
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        ...
        <form onSubmit={handleSearch} className="mb-8 flex flex-col md:flex-row gap-4 items-end">
          <div>
            <label htmlFor="searchEmail" className="block text-sm font-medium text-gray-700">Email</label>
            <input
              ref={emailInputRef}
              id="searchEmail"
              type="email"
          ...
          <div>
            <label htmlFor="searchOrderNumber" className="block text-sm font-medium text-gray-700">Order Number</label>
            <input
